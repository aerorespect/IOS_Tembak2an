...
class GameScene: SKScene,SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        tapToStartNewLabel.fontSize = 100
        tapToStartNewLabel.fontColor = SKColor.white
        tapToStartNewLabel.position = CGPoint(x: self.size.width/2, y: self.size.height*0.5)
        tapToStartNewLabel.zPosition = 1
        tapToStartNewLabel.alpha = 0
        self.addChild(tapToStartNewLabel)
    ...
    func startGame(){
        ...
        tapToStartNewLabel.run(deleteSequence)
